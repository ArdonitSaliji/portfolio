const data = [
  {
    name: "Sociopedia",
    image: [
      require("../../images/socio.png"),
      require("../../images/socio2.png"),
      require("../../images/socio3.png"),
    ],
  ...
  },
  {
    name: "chess",
    image: [
      require("../../images/chess1.png"),
      require("../../images/chess2.png"),
    ],
    title: "Chess Game",
    github:
      "https://github.com/ArdonitSaliji/TypeScript/tree/main/chess-project",
  ...
  },
  {
    name: "snake",
    image: [
      require("../../images/snake-game1.png"),
      require("../../images/snake-game2.png"),
    ],
    title: "Snake Game",
    github:
      "https://github.com/ArdonitSaliji/JavaScript/tree/main/snake-project",
    demo: "https://ardonitsaliji.github.io/snake-game/",
  },
  {
    name: "db-management",
    image: [
      require("../../images/db-manag1.png"),
      require("../../images/db-manag2.png"),
      require("../../images/db-manag3.png"),
      require("../../images/db-manag4.png"),
    ],
    title: "Database User Management",
    github: "https://github.com/ArdonitSaliji/db-user-management",
...
export const more = [
  {
    name: "meme",
    image: [
      require("../../images/jokes3.png"),
      require("../../images/jokes.png"),
    ],
