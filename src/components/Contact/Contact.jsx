...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    e.preventDefault()
    emailjs.sendForm('service_uxg2hyc', 'template_e3fgctp', form.current, 'S_CwvCXPZj5jA-fvu')
    e.target.reset()
  }
  return (
    <section id='contact'>
      ...
      <div className='container contact__container'>
        <div className='contact__options'>
          ...
          <article className='contact__option'>
            ...
            <h4>WhatsApp</h4>
            <h5>+38970580897</h5>
            <a href='https://api.whatsapp.com/send?phone=+389070580897' target='_blank' rel='noreferrer'>
              Send a message
            </a>
          </article>
        </div>
